...
public class RankCommand extends CytosisCommand {
    ...
    public RankCommand() {
        ...
        addSyntax((sender, context) -> {
            ...
            Cytosis.getDatabaseManager().getMysqlDatabase().getPlayerRank(target).thenAccept(rank -> {
    ...
    private void setRank(UUID uuid, PlayerRank oldRank, PlayerRank rank, CommandSender sender) {
        ...
        Cytosis.getDatabaseManager().getMysqlDatabase().setPlayerRank(uuid, rank).thenAccept(unused -> {
